...
:root {
  ...
  --card:#fff; --lime:#c8ff1a; --gold:#ffd43d; --rose:#ff75a8;
...
.badge {
  ...
  border:1px solid rgba(16,19,31,.10); border-radius:999px;
...
h1 { max-width:850px; margin:16px 0 0; font-size:clamp(34px,4.4vw,62px); line-height:1.02; letter-spacing:0; text-wrap:pretty; overflow-wrap:anywhere; }
...
.technical-details > summary, .summary-signals > summary { cursor:pointer; font-weight:900; list-style-position:inside; }
...
.evidence-card b { display:inline-flex; padding:5px 9px; border-radius:999px; background:linear-gradient(90deg,var(--lime),var(--gold)); font-size:12px; }
...
.evidence-link { display:inline-flex; margin:2px 4px 2px 0; padding:4px 8px; border:1px solid #9bc7bd; border-radius:6px; color:#11665b; font-weight:800; text-decoration:none; }
...
.thumb { display:block; width:100%; padding:0; overflow:hidden; border:1px solid rgba(16,19,31,.12); border-radius:8px; background:#10131f; }
.thumb img, .media-tile img { display:block; width:100%; aspect-ratio:16/10; object-fit:cover; background:#10131f; }
.jump { display:inline-flex; width:max-content; min-height:31px; align-items:center; padding:6px 10px; border:1px solid rgba(16,19,31,.12); border-radius:999px; background:#fff; text-decoration:none; font-size:12px; font-weight:950; }
.inline-preview { width:max-content; padding:0; border:0; background:transparent; color:var(--ink); text-align:left; font-weight:950; }
...
.media-tile > button { display:block; width:100%; padding:0; border:0; background:#10131f; }
...
.lightbox { position:fixed; inset:0; z-index:50; display:grid; place-items:center; padding:22px; }
.lightbox-backdrop { position:absolute; inset:0; background:rgba(16,19,31,.72); backdrop-filter:blur(10px); }
...
.lightbox-panel header button { min-height:34px; padding:6px 12px; border:1px solid rgba(16,19,31,.16); border-radius:999px; background:#fff; font-weight:950; }
