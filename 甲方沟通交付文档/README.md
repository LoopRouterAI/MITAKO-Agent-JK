...
1. [0714 反馈整改与验收说明](./0714反馈整改与验收说明-2026-07-15.md)：本轮已关闭问题、证据和甲方联调边界。
2. [0714 对抗式验收报告](../docs/delivery/mitako-0714-adversarial-acceptance-20260715.html)：多角色审查、根因、修复和自动化结果。
3. [新版本交付说明-2026-07-11.md](./新版本交付说明-2026-07-11.md)：系统、能力和此前交付基线。
4. [客服Agent与视觉审核对接指南.md](./客服Agent与视觉审核对接指南.md)：客服 Agent、人工客服和视觉审核如何协同。
5. [甲方对接物料与接口清单.md](./甲方对接物料与接口清单.md)：甲方需要准备的系统、字段、权限、样本和负责人。
6. [甲方POC测试说明.md](./甲方POC测试说明.md)：现场或远程验收步骤。
