...
当前唯一业务真源是[四场景审核业务决策与报告契约](../docs/product/四场景审核业务决策与报告契约-20260812.md)，执行状态以[四场景审核主线进度](../docs/product/四场景审核主线进度-20260814.md)为准。[0817 四场景审核业务理解与发布验收说明](./0817四场景审核业务理解与发布验收说明.html)是当前甲方人话版；此前的 0814、0812、0809 等说明只保留追溯，不能代表当前完成状态。
...
报告中的视频证据需要启动正式 API 才能使用签名 URL 跳转；内部研发包另有离线 WebP 图片证据包。图片包包含身份证、支付等敏感材料，客户 ZIP 有意不携带，避免未经授权复制个人信息；客户环境请通过授权 API 查看图片证据。
