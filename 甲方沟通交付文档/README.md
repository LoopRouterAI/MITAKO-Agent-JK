...
1. [0717 网页端视频读取问题整改与验收报告（HTML）](./0717网页端视频读取问题整改与验收报告.html)：说明 API 成功但网页失败的根因、系统隐藏文件过滤、坏视频隔离、验收证据和复测步骤。
2. [甲方测试版与本轮更新说明（HTML）](./甲方测试版与本轮更新说明-2026-07-16.html)：用非研发语言说明两个包的区别、本轮九项更新、当前可测内容、演示数据及待联调边界。
3. [视觉审核工程增强验收报告](../docs/delivery/mitako-visual-evaluation-engineering-acceptance-20260716.html)：完整说明三通道审核、损伤因果、主体连续性、发错/漏发对账与自动化证据。
4. [视觉审核下一轮测试建议](./视觉审核下一轮测试建议-2026-07-16.md)：完整上下文盲测、审核强度、风险指标与双方联调边界。
5. [0714 反馈整改更新日志（HTML）](./0714反馈整改更新日志-2026-07-15.html)：0714 反馈如何落地、如何复验及哪些仍待联调。
6. [0714 对抗式验收报告](../docs/delivery/mitako-0714-adversarial-acceptance-20260715.html)：多角色审查、根因、修复和自动化结果。
7. [客服Agent与视觉审核对接指南.md](./客服Agent与视觉审核对接指南.md)：客服 Agent、人工客服和视觉审核如何协同。
8. [甲方对接物料与接口清单.md](./甲方对接物料与接口清单.md)：甲方需要准备的系统、字段、权限、样本和负责人。
9. [甲方POC测试说明.md](./甲方POC测试说明.md)：现场或远程验收步骤。
