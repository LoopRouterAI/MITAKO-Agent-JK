...
- 客服主链路：发货慢、清关慢、仓库慢、物流慢、退货退款、商品破损、未成年人退款等问题，由客服 Agent 先承接情绪、整理上下文、提示补件，必要时转人工。
- 三类视觉审核：开箱视频/发错货、商品有伤、未成年人资料审核，为人工客服输出证据摘要、置信度、缺失材料和复核建议。
...
| MITAKO -> 甲方 | POST | `{callbackBase}/mitako/customer-service-event` | 转人工、补件、升级等事件回调 |
