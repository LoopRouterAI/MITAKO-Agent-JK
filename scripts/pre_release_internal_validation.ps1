...
try {
    ...
    Invoke-Step "0731 claimed-item, damage evidence and blind-bundle regression" { & $Python -m unittest tests.visual_review.test_damage_causality tests.visual_review.test_object_continuity tests.visual_review.test_continuity_model_pass tests.visual_review.test_blind_review_bundle }
