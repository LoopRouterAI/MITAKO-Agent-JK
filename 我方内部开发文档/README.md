...
4. [升级日志-2026-07-16.md](./升级日志-2026-07-16.md)：0715 评测复核、Strong 审核、三通道因果/连续性、履约对账、非 AI 取证和报告证据链升级。
5. [内部研发包交付说明.md](./内部研发包交付说明.md)：源码、Key、数据库、样本和敏感数据交付边界。
6. [客服Agent视觉审核系统设计指南.md](./客服Agent视觉审核系统设计指南.md)：客服与视觉审核内部设计。
7. [0714 对抗式验收报告](../docs/delivery/mitako-0714-adversarial-acceptance-20260715.html)：本轮完成度、证据和甲方联调边界。
8. [全量需求复验报告](../docs/delivery/mitako-full-requirement-reaudit-20260711.html)：此前全量需求基线和生产阻塞项。
