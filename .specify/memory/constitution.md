...
### II. 情绪价值与业务准确并重
先共情后事实；结构化卡片与流式文本必须服从本轮任务。L4 情绪只建议人工并继续提供实质方案；仅 L5+、法律升级、敏感账户操作或用户明确要求时触发真实转VIP客服路径。材料人工复核、业务审批与会话转人工必须分离。
...
**Version**: 1.1.0 | **Ratified**: 2026-06-17 | **Last Amended**: 2026-07-14
