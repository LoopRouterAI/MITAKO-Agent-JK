...
class ContinuityModelPassTest(unittest.TestCase):
    ...
    def test_native_dimension_check_accepts_timestamp_based_video_evidence(self):
        parsed = {
            ...
            "evidence_refs": [
                {"field": "claimed_item", "asset_ref": "native_video_1", "timestamp": "00:08.20"},
                {"field": "claimed_item", "asset_ref": "native_video_1", "timestamp": "00:09.20"},
            ],
        }
    ...
    def test_gemini_product_damage_uses_overlapping_compact_frame_batches(self):
        case = dict(self.case)
        case["frames"] = [
            {
        ...
        def recording_call(cfg, current_case, timeout, retries):
            ...
            if current_structured.get("analysis_mode") == "sampled_video_batch_observation":
                observed.append({
                    "frames": list(current_case.get("frames") or []),
        ...
        self.assertEqual([len(item["frames"]) for item in observed], [24, 24, 5])
        ...
        self.assertEqual(result["chunking"]["segment_count"], 3)
        ...
        if mode == "object_continuity_only":
            ...
            parsed = {
                ...
                "damage_causality_assessment": {
                    ...
                    "action_evidence": [{**common, "global_frame_index": 2, "timestamp": "00:01.00", "action_relation": "direct_contact", "fact": "用户直接接触并撕拉"}],
    ...
    def test_gemini_product_damage_retires_universal_and_specialized_passes(self):
        case = dict(self.case)
        structured = dict(self.case["structured_business_context"])
        ...
        self.assertNotIn("damage_causality_only", observed_modes)
    ...
    def test_gemini_product_damage_does_not_restore_legacy_passes_for_ab_flags(self):
        case = dict(self.case)
        structured = dict(self.case["structured_business_context"])
        structured["damage_causality_policy"] = {"force_action_scan": True}
        case["structured_business_context"] = structured
    ...
    def test_compact_frame_pipeline_does_not_spawn_damage_only_repair(self):
        case = dict(self.case)
        structured = dict(self.case["structured_business_context"])
        structured["damage_causality_policy"] = {"force_action_scan": True}
        case["structured_business_context"] = structured
